...
<script type="text/javascript" src="${ctxStatic}/app/modules/sys/buses.js?_=${sysInitTime}" charset="utf-8"></script>
<%-- 隐藏iframe --%>
<iframe id="buses_temp_iframe" style="display: none;"></iframe>
<%-- 列表右键 --%>
<div id="buses_datagrid_menu" class="easyui-menu" style="width:120px; ">
...
<div class="easyui-layout" fit="true" style="margin: 0px;border: 0px;overflow: hidden;width:100%;height:100%;">
    ...
    <div data-options="region:'north',title:'过滤条件',collapsed:false,split:false,border:false"
        ...
        <form id="buses_search_form" style="padding: 5px;">
            &nbsp;筛选类型:
        ...
        <option value="意见">意见</option>  
            ...
            <a class="easyui-linkbutton" href="#" data-options="iconCls:'easyui-icon-no',width:100,height:28" onclick="javascript:$buses_search_form.form('reset');">重置查询</a>
        </form>
    </div>
    <%-- 中间部分 列表 --%>
    <div data-options="region:'center',split:false,border:false"
         style="padding: 0px; height: 100%;width:100%; overflow-y: hidden;">
        <table id="buses_datagrid"></table>
    </div>
</div>
