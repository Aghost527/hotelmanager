...
$(function () {
    ...
    $log_datagrid = $('#log_datagrid').datagrid({
        ...
        idField: 'id',
        columns: [ [
            {field: 'activity',title: 'activity',width: 80 } ,
            {field: 'joinLevel', title: 'joinLevel', width: 100} ,
            {field: 'capacity', title: 'capacity', width: 100} ,
            {field: 'beginDate',title: 'beginDate', width: 160},
            {field: 'endDate',title: 'endDate',width: 200},
            {field: 'dealNo',title: 'dealNo',width: 136} 
