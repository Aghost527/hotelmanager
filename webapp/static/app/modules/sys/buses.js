...
$(function () {
    ...
    $log_datagrid = $('#log_datagrid').datagrid({
        ...
        columns: [ [
            ...
            {field: 'lines', title: 'lines', width: 100} ,
            {field: 'destination', title: 'destination', width: 100} ,
            {field: 'departTime',title: 'departTime', width: 160},
            {field: 'carType',title: 'carType',width: 200},
            {field: 'capacity',title: 'capacity',width: 136} ,
            {field: 'price',title: 'price',width: 100},
            {field: 'takenBy',title: 'takenBy',width: 200 }
        ]],
        toolbar:[{
            text:'删除',
