 ...
 */
@Service
public class BusesManager extends EntityManager<Buses, Long> {

	private HibernateDao<Buses, Long> BusesDao;
	...
	public void setSessionFactory(final SessionFactory sessionFactory) {
		BusesDao = new HibernateDao<Buses, Long>(sessionFactory,
				Buses.class);
	}

	@Override
	protected HibernateDao<Buses, Long> getEntityDao() {
		return BusesDao;
	}
}
