 ...
 */
@Service
public class RoomsManager extends EntityManager<Rooms, Long> {

	private HibernateDao<Rooms, Long> RoomsDao;
	...
	public void setSessionFactory(final SessionFactory sessionFactory) {
		RoomsDao = new HibernateDao<Rooms, Long>(sessionFactory,
				Rooms.class);
	}

	@Override
	protected HibernateDao<Rooms, Long> getEntityDao() {
		return RoomsDao;
	}
}
