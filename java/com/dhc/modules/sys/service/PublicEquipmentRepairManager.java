 ...
 */
@Service
public class PublicEquipmentRepairManager extends EntityManager<PublicEquipmentRepair, Long> {

	private HibernateDao<PublicEquipmentRepair, Long> PublicEquipmentRepairDao;
	...
	public void setSessionFactory(final SessionFactory sessionFactory) {
		PublicEquipmentRepairDao = new HibernateDao<PublicEquipmentRepair, Long>(sessionFactory,
				PublicEquipmentRepair.class);
	}

	@Override
	protected HibernateDao<PublicEquipmentRepair, Long> getEntityDao() {
		return PublicEquipmentRepairDao;
	}
}
