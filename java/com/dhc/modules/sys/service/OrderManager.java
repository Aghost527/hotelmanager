 ...
 */
@Service
public class OrderManager extends EntityManager<Order, Long> {

	private HibernateDao<Order, Long> OrderDao;
	...
	public void setSessionFactory(final SessionFactory sessionFactory) {
		OrderDao = new HibernateDao<Order, Long>(sessionFactory,
				Order.class);
	}

	@Override
	protected HibernateDao<Order, Long> getEntityDao() {
		return OrderDao;
	}
}
