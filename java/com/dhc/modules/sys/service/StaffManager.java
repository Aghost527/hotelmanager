 ...
 */
@Service
public class StaffManager extends EntityManager<Staff, Long> {

	private HibernateDao<Staff, Long> StaffDao;
	...
	public void setSessionFactory(final SessionFactory sessionFactory) {
		StaffDao = new HibernateDao<Staff, Long>(sessionFactory,
				Staff.class);
	}

	@Override
	protected HibernateDao<Staff, Long> getEntityDao() {
		return StaffDao;
	}
}
