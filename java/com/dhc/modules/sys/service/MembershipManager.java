 ...
 */
@Service
public class MembershipManager extends EntityManager<Membership, Long> {

	private HibernateDao<Membership, Long> MembershipDao;
	...
	public void setSessionFactory(final SessionFactory sessionFactory) {
		MembershipDao = new HibernateDao<Membership, Long>(sessionFactory,
				Membership.class);
	}

	@Override
	protected HibernateDao<Membership, Long> getEntityDao() {
