 ...
 */
@Service
public class DealManager extends EntityManager<Deal, Long> {

	private HibernateDao<Deal, Long> DealDao;
	...
	public void setSessionFactory(final SessionFactory sessionFactory) {
		DealDao = new HibernateDao<Deal, Long>(sessionFactory,
				Deal.class);
	}

	@Override
	protected HibernateDao<Deal, Long> getEntityDao() {
		return DealDao;
	}
}
